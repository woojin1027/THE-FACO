...
def nameSelect(Name):
    busid = [206000040,206000087,206000082,2060000299,206000613,206000725,101000001,101000005,101000148,102000070]
    busname = ['ori','mikoom','bundangkoo_office','seohyun','imecheon','jungja','Namdaemun','seoulstation','MyeongdongK','Soonchunhyang']
    order = [5,7,10,5,6,9,31,26,30,34]
    busnumber = [8100,81004102,8100,4102,4102,81004102,81004102,8100,81004102,8100]
    if Name in busname:
